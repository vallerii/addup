            ...
            <div className="grid lg:grid-cols-3 gap-2 mb-8">
              ...
              <div className="lg:col-span-2 bg-neutral-1000 rounded-3xl p-6">
                <div className="space-y-3">
                  ...
                  {/* Table Rows */}
                  {[...Array(7)].map((_, i) => (
                    <div key={i} className={`grid grid-cols-4 gap-4 px-3.5 py-3 rounded-lg ${i === 1 ? 'bg-neutral-900' : ''} hover:bg-neutral-900 transition-colors`}>
                      ...
                      <div className="text-right self-center">
                        <button className="text-xs font-medium text-white bg-neutral-900 px-3 py-1 rounded-full hover:bg-primary-400 transition-colors">
                          Trade
                        </button>
                      </div>
                    </div>
