...
export default function Hero() {
  return (
    <section className="pt-24 lg:pt-32 pb-12 lg:pb-20 px-4 sm:px-8">
      <div className="max-w-[1728px] mx-auto">
        <div className="bg-white rounded-[30px] overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-0 p-8 lg:p-16">
            {/* Left Content */}
            <div className="flex flex-col justify-center gap-12 lg:gap-16 max-w-[632px]">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-3 px-4 py-2 border border-neutral-200 rounded-xl">
            ...
            <div className="relative flex items-center justify-center lg:justify-end">
              <div className="relative w-full max-w-[500px] aspect-[4/5]">
                ...
                <img 
                  src="https://cdn.builder.io/api/v1/image/assets%2Fbb534d7e17ed484dad392ccecf95bc70%2F6d346916653e40399efd44e4bc4c6291?format=webp&width=800" 
